...
export const DATA_USE_NOTICE_COPY = {
  ...
  body: 'Build a non-confidential, high-level project brief with Balance Assist, or talk directly with the Balance team. AI mode uses DeepSeek to process messages and text extracted from supported files. AI stays in this temporary session pending producer-transfer approval. Selecting team contact permits your relay message to be delivered to the Balance Assist team. A producer confirms scope, timing, pricing, availability, and contracts. Your same-browser temporary draft is kept for up to 24 hours. Nothing is sent to Telegram or Monday.com until you explicitly approve transfer. You can request deletion; downstream copies and backups are handled separately.',
