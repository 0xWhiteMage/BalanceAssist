...
const SENSITIVE_VALUE = /(?:https?:\/\/|\b[\w.+-]+@[\w.-]+\.[a-z]{2,}\b)/i;

export function sanitizeObservabilityData(data: Record<string, unknown>, allowedFields?: readonly string[]): Record<string, unknown> {
