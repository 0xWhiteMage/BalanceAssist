...
export const conversationSteps: Record<ConversationStepId, ConversationStep> = {
  ...
  timeline: {
    id: 'timeline',
    botMessages: ['What timeline are you working with?'],
  ...
  budget: {
    id: 'budget',
    botMessages: ['What budget range are you working with? This helps me suggest the right approach.'],
  ...
  'contact-email': {
    id: 'contact-email',
    botMessages: ['And what\'s the best email to reach you?'],
    freeText: true,
    field: 'contactEmail',
    next: 'qualification'
  },
