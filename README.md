...
```bash
Apply the full incremental migration chain in order, through `043_deletion_state_batched_cleanup.sql` (except intentionally absent `005`). Do not combine it with legacy snapshot `000_full_schema.sql`.
```
